...
<c:choose>
    <c:when test="${empty topic.name}">
        <c:set var="formAction" value="/admin/topic/create" />
        <c:set var="button" value="Add" />
    </c:when>
    <c:otherwise>
        <c:set var="formAction" value="/admin/topic/${topic.id}" />
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <form:input path="name" class="form-control" name="firstName" id="firstName"  placeholder="Enter topic name"/>
                        </div>
                    </div>
                </div>
